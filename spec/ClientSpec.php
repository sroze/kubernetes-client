...
class ClientSpec extends ObjectBehavior
{
    ...
    function it_returns_adapter_node_repository(AdapterInterface $adapter, NodeRepository $nodeRepository)
    {
        $adapter->getNodeRepository()->shouldBeCalled()->willReturn($nodeRepository);
        $this->getNodeRepository()->shouldReturn($nodeRepository);
    }

    function it_returns_adapter_namespace_repository(AdapterInterface $adapter, NamespaceRepository $namespaceRepository)
    {
    ...
    function it_returns_namespace_client_from_adapter(AdapterInterface $adapter, KubernetesNamespace $namespace, NamespaceClient $namespaceClient)
    {
